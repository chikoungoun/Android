package com.pharma.pharma_tunis;
 ...
 */
public class Tab1 extends Fragment implements PharmacieAdapter.OnItemClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        emptyStateTextView = (TextView)view.findViewById(R.id.empty_view);

        rvPharmacies = view.findViewById(R.id.rvPharmacies);
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray jsonArray) {
                        try {
                            ...
                            adapter = new PharmacieAdapter(getContext(),pharmaciesList);
                            rvPharmacies.setAdapter(adapter);
                            ...
                            adapter.setOnItemClickListener(Tab1.this);
    ...
    public void  swipablePart(){
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.RIGHT) {
            ...
            public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                ...
                final Drawable dial_icon = ContextCompat.getDrawable(getContext(),R.drawable.call_white_24dp);
    ...
    public void onItemClick(int position) {
        ...
        Toast.makeText(getContext(),""+clickedItem.getCoordonnee(),Toast.LENGTH_SHORT).show();
